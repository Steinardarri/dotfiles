...
let
  ...
  in [
    ...
    "Super Control, Space, ${d} Sherlock launcher, exec, sherlock" # Sherlock has a daemon
  ];
  ...
  in [
    ...
    "Super, E, ${d} Thunar file explorer, exec, uwsm-app -- thunar"
    "Super Shift, E, ${d} dropdown Thunar file explorer, exec, [float; move 5% 5%; size 60% 60%] uwsm-app -- thunar"
