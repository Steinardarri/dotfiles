{pkgs, ...}: {
  ...
  home.file.".local/bin/cinnamon-desktop-editor" = {
    executable = true;
    text = ''
      #!/usr/bin/python3
      ...
      os.execvp(f"{os.environ['XDG_DATA_HOME']}/cinnamon/cinnamon-desktop-editor/cinnamon-desktop-editor.py", (" ",) + tuple(sys.argv[1:]))
    '';
  };
  home.file.".local/share/cinnamon/cinnamon-desktop-editor/cinnamon-desktop-editor.py" = {
    executable = true;
    text = ''
      #!/usr/bin/python3
